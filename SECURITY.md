...
If you find a security vulnerability in Async Sharepoint, please report it through [GitHub's private vulnerability reporting](https://github.com/deanm0000/Async-Sharepoint/security/advisories/new). This keeps the details private while we work on a fix.
...
**Enterprise support** is available, with priority response SLAs. Contact powertrading121@gmail.com for details.
